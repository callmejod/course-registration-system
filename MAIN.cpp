...
class User
{
    ...
    int register_course()
    {
        ...
        else
        {
            ...
            if (completedCourses[0] == "None")
                completedCourses[0] = ordered_courses[idx];
            else
                completedCourses.push_back(ordered_courses[idx]);
...
public:
    ...
    int login()
    {
        ...
        cout << "Get all your course Registered\n";
        ...
        while (1)
        {
            ...
            bool b = false;
            if (!option.empty() && std::all_of(option.begin(), option.end(), [](char c)
...
void createUser()
{
    ...
    cout << "Enter the username you would like to have\n: ";
    cin >> username;
...
int main()
{
    ...
    cout << "\n";
    cout << "\t#####Competitive Coding##### \t\t\t\t@@@@@Topological Sorting@@@@@\n";
    cout << "\n";
    cout << "\t\t\t\t\tPresented by" << endl;
    cout << "\n";
    cout << "\t\tMishra Arvind \t\t\tAkshat Srivastav\t\t\tMishra Hardik" << endl;
    cout << "\n";
